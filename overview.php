    ...
    <div class="container_main abt-us-margin abt-us-jpinfra">
      ...
      <div class="abtus-jpinfra">
        <div class="abtus-txt">
          ...
          <p class="fontweight" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="2000">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
        </div>
        <div class="abtus-img">
    ...
    <div class="achievements container_main">
      ...
      <div class="achievements-slider">
        <div class="abtpage-achievement">
          <img src="img/about-us/Achievements.png" alt="achievements1">
          <p class="fontweight achievements-p">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
        </div>
        <div class="abtpage-achievement">
          <img src="img/about-us/Achievements.png" alt="achievements2">
          <p class="fontweight achievements-p">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
        </div>
        <div class="abtpage-achievement">
          <img src="img/about-us/Achievements.png" alt="achievements3">
          <p class="fontweight achievements-p">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
        </div>
        <div class="abtpage-achievement">
          <img src="img/about-us/Achievements.png" alt="achievements3">
