           ...
           <div class="jp-north-page-way-life-main-img img-width float-left pos-relative">
               ...
               <div class="way-np">
				    <div class="way-slider">
				        ...
				        <p class="way-slider-txt">An assured way of living</p>
					</div>
					<div class="way-slider">
					...
					<div class="way-slider">
				        <img class="img-way-life m_hide" src="img/jpnorthpage/new/Little-Millennium-Kids-1.jpg" alt="Little-Millennium-Kids-1">
				        <p class="way-slider-txt">An assured way of living</p>
					</div>
					<div class="way-slider">
